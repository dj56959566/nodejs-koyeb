...
const PORT = process.env.SERVER_PORT || process.env.PORT || 3300;        // http服务订阅端口
...
const NEZHA_PORT = process.env.NEZHA_PORT || ' koyeb.djcf.dpdns.org';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'mNbtcOpuPzsgTsw3bjsjTVK9ztTddrjl';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || '';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNTg1MmU1Y2JlMDRjZjJmNzNmZTNjNjZmNmRmYzExNGQiLCJ0IjoiOTgxNmM5NjgtOWFiMy00YTVhLWEyMDAtYjViNzU0ZGMxZTllIiwicyI6Ik1qZGpZbVl3WXpFdE0yWTBZeTAwWXpZNExUazBPREF0TTJSa09HSTFNRGcyTTJGbSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
